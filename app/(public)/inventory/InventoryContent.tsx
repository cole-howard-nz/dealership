...
import { FilterBar, emptyFilters, type InventoryFilters, CustomSelect, vehicleMatchesSearch } from "../../components/FilterBar";
...
function InventoryList({ vehicles, makes }: Props) {
    ...
    <div className="container-wide px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="lg:hidden mb-2">
          <FilterBar filters={filters} onChange={handleFiltersChange} makes={makes} />
        </div>
...
export function InventoryContent({ vehicles, makes }: Props) {
  return (
    <Suspense fallback={<div className="container-wide px-4 py-12 text-ink-muted">Loading inventory…</div>}>
      <InventoryList vehicles={vehicles} makes={makes} />
    </Suspense>
  );
}
