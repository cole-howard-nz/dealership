...
export function AuditFilters({ currentQ, currentAction, currentEntity, actionLabels, entityLabels }: Props) {
    ...
    <div className="flex flex-wrap gap-2 mb-5 items-center">
      ...
      <div className="relative">
        <select
          ...
          className={selectClass}
          style={selectStyle}
          onChange={(e) => push({ entity: e.target.value || undefined })}
        >
      ...
      {hasFilters && (
        <button
          onClick={() => push({ q: undefined, action: undefined, entity: undefined })}
